...
/* initializing the EPSG defs list */
    ...
    add_srs_wkt (p, 9,
        "[\"Mayotte\"],BBOX[-14.49,43.68,-11.33,46.7]],ID[\"EPSG\"");
    add_srs_wkt (p, 10,
        ",7038]]");
    ...
    add_srs_wkt (p, 9,
        ",AREA[\"French Guiana\"],BBOX[2.11,-54.6,8.88,-49.46]],I");
    add_srs_wkt (p, 10,
        "D[\"EPSG\",7040]]");
    ...
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +no_defs");
    add_srs_wkt (p, 0,
        "GEOGCRS[\"RGF93 (lon-lat)\",DATUM[\"Reseau Geodesique Fr");
    add_srs_wkt (p, 1,
        "ancais 1993\",ELLIPSOID[\"GRS 1980\",6378137,298.2572221");
    add_srs_wkt (p, 2,
        "01,LENGTHUNIT[\"metre\",1]]],PRIMEM[\"Greenwich\",0,ANGL");
    add_srs_wkt (p, 3,
        "EUNIT[\"degree\",0.0174532925199433]],CS[ellipsoidal,3],");
    add_srs_wkt (p, 4,
        "AXIS[\"geodetic longitude (Lon)\",east,ORDER[1],ANGLEUNI");
    add_srs_wkt (p, 5,
        "T[\"degree\",0.0174532925199433]],AXIS[\"geodetic latitu");
    add_srs_wkt (p, 6,
        "de (Lat)\",north,ORDER[2],ANGLEUNIT[\"degree\",0.0174532");
    add_srs_wkt (p, 7,
        "925199433]],AXIS[\"ellipsoidal height (h)\",up,ORDER[3],");
    add_srs_wkt (p, 8,
        "LENGTHUNIT[\"metre\",1]],USAGE[SCOPE[\"unknown\"],AREA[\"");
    add_srs_wkt (p, 9,
        "France\"],BBOX[41.15,-9.86,51.56,10.38]],ID[\"EPSG\",704");
    add_srs_wkt (p, 10,
        "2]]");
    ...
    add_srs_wkt (p, 9,
        "known\"],AREA[\"Caribbean - French Antilles\"],BBOX[14.0");
    add_srs_wkt (p, 10,
        "8,-63.66,18.54,-57.52]],ID[\"EPSG\",7085]]");
